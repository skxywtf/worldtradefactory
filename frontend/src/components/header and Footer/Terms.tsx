...
import FooterLand from "../landing page/header footer landing/FooterLand";

const Terms = () => {
  return (
    <div className="pt-32 h-full w-full flex flex-col items-center">
      <div className=" text-4xl">Terms & Conditions</div>
      <div className=" mt-10 px-5">
        These Terms of Use `Terms`` govern your access to and use of Skxywtf,
        which provide stock ratings and stock price predictions based on
        historical stock performance and market behavior. By accessing or using
        our services, you agree to be bound by these Terms. hat often hinder the
        success of individual investors.
      </div>
      <div className="text-xl mt-5 px-5 py-10">
        <h1 className="text-3xl">Accuracy and Limitations:</h1>
        <br />
        <br />
        Borea AI use historical stock performance and market behavior to
        generate stock ratings and price predictions. However, it is important
        to note that past performance is not indicative of future results.
        Therefore, Skxywtf does not guarantee the accuracy or reliability of the
        stock ratings or price predictions. You acknowledge that stock trading
        and investments carry inherent risks, and Borea AI`s services should not
        be solely relied upon to make investment decisions. It is recommended
        that you consult with a qualified investment professional or conduct
        independent research and verification before making any investment
        decisions.
      </div>

      <div className="text-xl mt-5 px-5 py-10">
        <h1 className="text-3xl">No Professional Advice:</h1>
        <br />
        <br />
        Skxywtf`s algorithms and services are designed to provide general
        information and analysis based on historical data. They should not be
        considered as professional investment advice. Skxywtf does not provide
        personalized investment recommendations or financial planning services.
        The use of Skxywtf`s services does not establish an advisory or
        fiduciary relationship between you and Skxywtf.
      </div>

      <div className="text-xl mt-5 px-5 py-10">
        <h1 className="text-3xl">User Responsibilities:</h1>
        <br />
        <br />
      ...
      <div className="text-xl mt-5 px-5 py-10">
        <h1 className="text-3xl">Governing Law and Jurisdiction:</h1>
        <br />
        <br />
