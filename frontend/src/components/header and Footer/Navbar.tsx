...
//   const router = useRouter(); // useRouter to handle redirection
...
//       router.push("/stock"); // Redirect to the stock page
//     }
//   };
...
//         <div className="flex h-full items-center justify-between w-full px-10 lg:px-20 py-5">
//           <Link
//             className={`text-2xl items-center text-center lg:text-3xl ${search ? "block" : "hidden"}`}
//             href="/main"
//           >
//             SKXYWTF
//           </Link>
//           <Link
//             className={`lg:text-3xl text-[0px] items-center text-center ${!search ? "lg:block" : "hidden"}`}
//             href="/main"
//           >
//             SKXYWTF
//           </Link>
...
//           <div className="flex justify-center items-center gap-5">
//             <div className={`${navbarBackground ? "flex" : "hidden"} transition duration-1000`}>
...
//                   className={`w-68 lg:w-[600px] text-black rounded-sm p-[1px] lg:p-[6px] px-3 search-input ${search ? "search-input" : "search-input-active"}`}
//                 />
//                 <button type="submit" className="rounded-full p-1 text-xl hover:bg-[rgba(80,77,77,0.55)]">
//                   {!search ? (
//                     <IoClose
//                       size={24}
//                       className="menu-icon cursor-pointer text-2xl"
...
//               </form>
//             </div>
//             <Link href="/main/signup" className="text-2xl p-2 rounded-full hover:bg-[rgba(80,77,77,0.55)]">
//               <CgProfile />
//             </Link>
//             <div
//               className="rounded-full p-2 text-xl lg:text-2xl hover:bg-[rgba(80,77,77,0.55)]"
...
//                 <CiLight size={24} className="cursor-pointer" />
//               ) : (
//                 <MdOutlineDarkMode size={24} className="cursor-pointer lg:text-3xl" />
//               )}
//             </div>
