  ...
  return (
    <div className="w-full h-auto py-10">
      ...
      <div className="lg:flex gap-5 w-full h-[80%] py-10 px-5 ">
        <div className="bg-[#212121] border border-gray-600 h-full lg:w-1/2 mb-10 lg:mb-1  rounded-lg py-3 lg:px-3">
        ...
        {/*  */}
        <div className="bg-[#212121] py-3 h-full border border-gray-600 lg:w-1/2 rounded-lg  lg:px-3">
