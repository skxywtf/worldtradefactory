...
// it will stop redirecting to other pages
// "use client";
// import React, { useEffect, useRef } from "react";
...
//       // Add event listener to prevent redirects
...
//       // Add click event listener to the container to prevent link redirects
...
//     // Cleanup function to remove the script and clear content
//     return () => {
//       clearTimeout(timeoutId);
//       if (container) {
...
const MarketData: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="tradingview-widget-container__widget"></div>
      <div className="tradingview-widget-copyright" style={{ display: "none" }}></div>
      {/* Hide the logo using CSS */}
    </div>
  );
};
