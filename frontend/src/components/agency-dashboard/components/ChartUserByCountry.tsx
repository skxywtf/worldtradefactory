...
import { styled } from '@mui/system'; // Use this instead of @mui/material/styles
...
const StyledText = styled('text', {
  shouldForwardProp: (prop) => prop !== 'variant', // Prevent forwarding 'variant' to the DOM element
