...
const MainSearch = () => {
  ...
  return (
    <div
      ...
      className="h-full w-full pt-20 fit transition"
    >
      <h1 className="w-full text-3xl lg:text-5xl pt-20 pb-10 text-center flex flex-wrap justify-center items-center">
        Unlocking Intelligent Financial Mastery
      </h1>
      <h1 className="w-full justify-center text-3xl lg:text-5xl pb-20 text-center">
        World Trade Factory
      </h1>
